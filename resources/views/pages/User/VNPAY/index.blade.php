...
<body style="font-size: 0.9rem;">
    <div class="container">
        ...
        <div class="table-responsive">
            <form action="{{route('online.payment')}}" id="frmCreateOrder" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" enabled="true" id="Amount" name="Amount" type="text" value="{{$totalPrice}}">
                </div>
                <div class="form-group">
                    <label for="OrderDescription">Nội dung thanh toán</label>
                    <textarea class="form-control" cols="20" id="OrderDescription" name="OrderDescription" rows="2">Thanh toan don hang thoi gian: 2024-04-17 22:59:21</textarea>
                </div>
                <div class="form-group">
    ...
    <div id="vnpay_modal" class="vnpay_modal" style="display: none;">
        <div id="vnpay_content" class="vnpay_content"></div><a id="vnpay_close" href="#" class="vnpay_close">close</a>
    </div>
</body>
