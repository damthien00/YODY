    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="ml-2" action="{{ route('color.store')}}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Nhập tên màu sắc" name="color_name" id="product_name" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Mã code
                                    <span title="Tên sản phẩm không bao gồm các giá trị thuộc tính như màu sắc, chất liệu, kích cỡ...">
                                ...
                                <input type="color" placeholder="Nhập tên màu sắc" name="code" id="product_name" class="form-control">
                            </div>
