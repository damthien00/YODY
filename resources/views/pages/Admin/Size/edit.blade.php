...
<div class="content container-fluid">
    <div class="content container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form class="ml-2" action="{{ route('size.update', ['id' => $size->id])}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nhập tên sản phẩm" value="{{$size->size_name}}" name="size_name" id="product_name" class="form-control">
                    </div>
