                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên danh mục" value="{{$category->category_name}}" name="category_name" id="category_name" class="form-control" type="text" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Danh mục cha: </label>
                            <select class="form-control" name="parent_category_id" id="editParentCategory">
                    ...
                    <div class="card-body">
                        <form id="file-upload-form" class="uploader">
                            ...
                            <label for="file-upload" id="file-drag">
                                <img id="file-image" src="{{asset($category->image)}}" alt="Preview" class="hidden">
                                <div id="start">
