...
@section('content')
<link rel="stylesheet" href="{{asset('assets/admin/css/form-check.css')}}">
<style>
    .uploader label {
        float: left;
        clear: both;
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên danh mục" name="category_name" id="category_name" class="form-control" type="text" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-check mt-3">
                            <input name="is_featured" class="form-check-input" type="checkbox" checked value="Nổi bật" id="flexCheckDefault">
