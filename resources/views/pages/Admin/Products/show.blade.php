           ...
           <div class="row align-items-center">
               <div class="col">
                   <ul class="breadcrumb-button">
                       <li class="breadcrumb-button-item">
                           <button class="btn p-2" href="index.html">
                               <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24" font-size="24" class="jss291">
                           ...
                           <button class="btn p-2" href="index.html">
                               <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" font-size="24" class="jss291">
                       ...
                       <li class="breadcrumb-button-item">
                           <a href="{{route('admin.category.show')}}">
                               <button class="btn">Danh mục</button>
                           </a>
                       </li>
                       <li class="breadcrumb-button-item">
               ...
               <div class="col-auto float-right ml-auto">
                   <a href="{{route('products.create')}}" class="btn add-btn">
                       ...
                       <span style="font-weight: 500;">Thêm sản phẩm</span>
                   </a>
               </div>
           </div>
       </div>
               ...
               <div class="card leave-box" id="client-info">
                   <div class="card-body">
                       <div class="row">
                           ...
                           <div class="col-md-5">
                               <form id="filter-form" method="GET" action="{{ route('products.show') }}">
                                   <div class='d-flex justify-content-between'>
                                       <div class="d-flex">
                                           <div class="dropdown" data-control="checkbox-dropdown">
                                               <label style="border-top-left-radius:5px;border-bottom-left-radius:5px;" class="dropdown-label">Loại sản phẩm</label>
                                               <div class="dropdown-list">
                                                   ...
                                                   <div class="dropdown-list-option">
                                                       ...
                                                       @php
                                                       $isChecked = in_array($category->id, explode(',', $categoryIds));
                                                       @endphp
                                                       <label class="dropdown-option">
                                                           <input type="checkbox" name="category_ids[]" {{ $isChecked ? 'checked' : '' }} value="{{ $category->id }}" />
                                           ...
                                           <div class="dropdown" data-control="checkbox-dropdown">
                                               <label class="dropdown-label">Ngày tạo</label>
                                               <div class="dropdown-list">
                                                   <div class="d-flex flex-column">
                                                       <div class="btn-date col-md-12 mb-2 d-flex gap-2">
                                                           <div class="form-group">
                                                               <div class="cal-icon">
                                                                   <input class="startDateInput form-control datetimepicker" value="{{ $createdOnMin }}" type="text">
                                                               </div>
                                                           </div>
                                                           <div class="p-3  ">-</div>
                                                           <div class="form-group">
                                                               <div class="cal-icon">
                                                                   <input class="endDateInput form-control datetimepicker" value="{{ $createdOnMax }}" type="text">
                                                               </div>
                                                           </div>
                                                       </div>
                                                   </div>
                                           ...
                                           <div class="dropdown" data-control="checkbox-dropdown">
                                               <label class="dropdown-label" style="border-top-right-radius:5px;border-bottom-right-radius:5px;">Nhãn hiệu</label>
                                               <div class="dropdown-list">
                                                   <div class="form-group form-search">
                                                       <span class="search-icon">
                                                           <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="search-icon" style="width: 20px; height: 20px;">
                                                   ...
                                                   <div class="dropdown-list-option">
                                                       ...
                                                       @php
                                                       $isChecked = in_array($brand->id, explode(',', $brandIds));
                                                       @endphp
                                                       <label class="dropdown-option">
                                                           <input type="checkbox" name="brand_ids[]" {{ $isChecked ? 'checked' : '' }} value="{{ $brand->id }}" />
                                                           {{ $brand->brand_name }}
                                                       </label>
                                                       @endforeach
                                                   </div>
                                       ...
                                       <button type="button" onclick="applyFilters()" class="btn btn-primary pl-4 pr-4 btn-fillter-product">Lọc</button>
                                   </div>
                               </form>
                           </div>
                       </div>
                                   ...
                                   <table class="table table-striped custom-table">
                                       ...
                                       <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="{{ route('admin.products.variants.detail', ['product_id' => $product->id, 'variant_id' => $product->variants->first()->id]) }}" title="Áo khoác Chino thời thượng SID56708">{{ $product->product_name }}</a></td>
                                               ...
                                               <td class="text-center">
                                                   <span class="d-block">{{ $totalInventoryQuantity }}</span>
                                                   <small>( {{ count($product->variants) }} phiên bản )</small>
                                               </td>
                                               <td class="text-center">
                                                   {{ $product->updated_at}}
                                               </td>
