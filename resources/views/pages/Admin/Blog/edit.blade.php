                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$blog->title}}" placeholder="Nhập tên sản phẩm" name="title" id="product_name" class="form-control">
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Nội dung tin tức</label>
                                    <textarea id="editorBlogDescription" name="content" id="summary">{{$blog->content}}</textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea id="editorBlogSummary" name="summary" id="summary">{{$blog->summary}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="dropdown" data-control="single-option">
                                <input type="hidden" class="dropdown-input" id="blog_cate_id" name="blog_cate_id" value="{{$blog->category->id}}">
                                <label class="dropdown-label">{{$blog->category->name}}</label>
                                <div class="dropdown-list">
                                    <div class="form-group form-search">
                                        <span class="search-icon">
                                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="search-icon" style="width: 20px; height: 20px;">
                    ...
                    <div class="card-body">
                        <form id="file-upload-form" class="uploader">
                            ...
                            <label for="file-upload" id="file-drag">
                                <img id="file-image" src="{{asset($blog->image)}}" alt="Preview" class="hidden">
                                <div id="start">
