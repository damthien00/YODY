    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                <a href="{{route('type_category.create')}}" class="btn add-btn">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($type_categories as $index => $type_category)
                                        <tr>
                                            <td><input type="checkbox" class="checkmail"></td>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a class="avatar" href="{{route('type_category.edit',['id'=> $type_category->id])}}" class="">
                                                        <img src="{{ asset( $type_category->image ) }}" alt="">
                                                    </a>
                                                </h2>
                                            </td>
                                            <td>
                                                <a href="{{route('type_category.edit',['id'=> $type_category->id])}}">
                                                    {{ $type_category->name }}
                                                </a>
                                            </td>
                                            <td class="text-center">{{ count($type_category->products) }}</td>
