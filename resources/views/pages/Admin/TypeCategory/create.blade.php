...
<form method="post" action="{{route('type_category.store')}}" enctype="multipart/form-data">
    <div class="header">
        <!-- Header Title -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên sản phẩm" name="name" id="name" class="form-control">
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea id="editorBlogDescription" name="description" id="summary"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
